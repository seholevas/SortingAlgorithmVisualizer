...
function Sort(nums =[], start, middle, end) 
{
    ...
    // while the poleter i from the start array hasn't incremented to middle+1 (which is where j begins) [0,1,2,..., middle]
    // and j poleter is still poleting to an index of the array [middle+1, 4,5,...,n]
